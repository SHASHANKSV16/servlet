...
public class BloodBookingServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.println("<div class=\"card text-center\">\n" +
                ...
                "    Blood Booking details \n" +
                "  </div>\n" +
                "  <div class=\"card-body\">\n" +
                "      <p><strong> Name:</strong> " + patientName + "</p> <p><strong>Hospital name :</strong> " + hospitalName + "</p> <p><strong>BloodGroup:</strong> " + bloodGroup + "</p> <p><strong>Address:</strong> " + address + "</p>  <p><strong>Urgency:</strong> " + urgency + "</p>"+
                "  </div>\n" +
                "</div>");
        writer.println("</div>");
