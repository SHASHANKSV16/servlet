...
public class ECommerceServlet extends HttpServlet {
    ...
    public ECommerceServlet() {
        System.out.println("ECommerceServlet is created");
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException, IOException {
        ...
        String quantity = req.getParameter("address");
        ...
        writer.println("<div class=\"card text-center\">\n" +
                ...
                "  </div>\n" +
                "  <div class=\"card-body\">\n" +
                "      <p><strong> Name:</strong> " + customerName + "</p> <p><strong>Email :</strong> " + email + "</p> <p><strong>Product:</strong> " + product + "</p> <p><strong>Quantity :</strong> " + quantity + "</p>  <p><strong>Payment method:</strong> " + paymentMethod + "</p>"+
                "  </div>\n" +
                "</div>");
        writer.println("</div>");
