...
@WebServlet(urlPatterns = "/movie", loadOnStartup = 1)
    ...
    public class MovieServlet extends HttpServlet {
        ...
        public MovieServlet() {
            System.out.println("MovieBookingServlet is created");
        }
...
//                    "  </div>\n" +
//                    "  <div class=\"card-body\">\n" +
//                    "      <p><strong> Name:</strong> " + fullName + "</p> <p><strong>Email:</strong> " + email + "</p> <p><strong>Service:</strong> " + service + "</p> <p><strong>Code:</strong> " + code + "</p>  <p><strong>Slot:</strong> " + slot + "</p>"+
//                    "  </div>\n" +
//                    "</div>");
//            writer.println("</div>");
