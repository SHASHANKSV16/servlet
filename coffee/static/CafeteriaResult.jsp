...
<div class="d-flex justify-content-center mt-5">
    <div class="card" style="width: 25rem">
        ...
        <div class="card-body">
            ...
            <h5>Cafeteria Name : ${name}</h5><br>
            <h5>Location : ${location}</h5><br>
            <h5>Type : ${type}</h5><br>
            <h5>Price : ${price}</h5><br>
            <h5>Franchise Name : ${franchise}</h5><br>
            <h5>Owner Name : ${owner}</h5><br>
            <h5>GST Number : ${gst}</h5><br>
