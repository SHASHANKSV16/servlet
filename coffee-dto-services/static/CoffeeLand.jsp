        ...
        <div class="card-body">
            <form method="post" action="coffeeLand">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="acre" placeholder="">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="expenditure" placeholder="">
                </div>
                <div class="mb-3">
                    <label  class="form-label"> Total Yeild</label>
                    <input type="number" class="form-control" name="totalYield" placeholder="">
                </div>
                <div class="mb-3">
                    <label  class="form-label"> Profit</label>
                    <input type="number" class="form-control" name="profit" placeholder="">
                </div>
                <div class="mb-3">
                    <label  class="form-label"> Fertilizer Quantity</label>
                    <input type="number" class="form-control" name="fertilizerQuantity" placeholder="">
                </div>
